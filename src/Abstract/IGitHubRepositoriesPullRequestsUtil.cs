...
public interface IGitHubRepositoriesPullRequestsUtil
{
    ...
    /// </summary>
    ValueTask<List<PullRequest>> GetAll(Repository repository, string? username = null, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
    ...
    /// </summary>
    ValueTask<List<PullRequest>> GetAll(string owner, string name, string? username = null, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
        bool log = true, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets all pull requests for a specific owner across all their repositories.
    /// </summary>
    ValueTask<List<PullRequest>> GetAllForOwner(string owner, string? username = null, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
        bool log = false, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets all non-approved pull requests for a specific repository.
    /// </summary>
    ValueTask<List<PullRequest>> GetAllNonApproved(string owner, string name, string? username = null, DateTimeOffset? startAt = null,
    ...
    /// </summary>
    ValueTask<List<PullRequest>> GetAllNonApprovedForOwner(string owner, string? username = null, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
        bool log = true, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    ValueTask ApproveAll(Repository repository, string message, string? username = null, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
        int delayMs = 0, CancellationToken cancellationToken = default);

    /// <summary>
    /// Approves all non-approved pull requests by owner and repo name.
    /// </summary>
    ValueTask ApproveAll(string owner, string name, string message, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null, string? username = null,
        int delayMs = 0, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    ValueTask<List<Repository>> FilterRepositoriesWithFailedBuilds(List<Repository> repositories, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
        bool log = true, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets all repositories for a given owner with at least one open pull request that has a failed build.
    /// </summary>
    ValueTask<List<Repository>> GetAllRepositoriesWithFailedBuildsOnOpenPullRequests(string owner, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
        bool log = true, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    ValueTask MergeAll(string owner, string name, string message, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null, string? username = null,
        int delayMs = 0, CancellationToken cancellationToken = default);

    /// <summary>
    /// Merges all pull requests with passing checks for a specific repository.
    /// </summary>
    ValueTask MergeAllWithPassingChecks(string owner, string name, string message, DateTimeOffset? startAt = null, DateTimeOffset? endAt = null,
    ...
    /// <param name="name">The name of the repository. Cannot be null or empty.</param>
    /// <param name="log">true to enable logging of the operation; otherwise, false.</param>
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the asynchronous operation.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains true if a failed run exists on any
    /// open pull request; otherwise, false.</returns>
